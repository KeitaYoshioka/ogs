...
public:
    ...
    PhaseFieldInSituLocalAssembler(PhaseFieldInSituLocalAssembler const&) =
        delete;
    PhaseFieldInSituLocalAssembler(PhaseFieldInSituLocalAssembler&&) = delete;

    PhaseFieldInSituLocalAssembler(
    ...
    {
        OGS_FATAL(
            "PhaseFieldInSituLocalAssembler: assembly without "
...
private:
    ...
    /// ID of the processes that contains mechanical1 process.
...
#include "PhaseFieldInSituFEM-impl.h"
